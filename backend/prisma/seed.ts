...
async function main() {
  const password =
    '$2b$10$EpRnTzVlqHNP0zQx.ZUx3.1c4.jNZZ.1c4.jNZZ.1c4.jNZZ.1c4.'; // Example hash or use a known one if available, or just a dummy string if auth service handles hashing.
